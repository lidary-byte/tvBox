...
//
//android {
//    namespace 'com.github.tvbox.osc.tk'
//    compileSdk 34
//
//    defaultConfig {
...
fun buildTime(): String {
    val format = SimpleDateFormat("yyyyMMdd_HHmm")
...
android {
    ...
    flavorDimensions += listOf("abi", "brand", "mode")
...
//            val flavorName = variant.flavorName?.replace("normal", "java") ?: "unknown"
//            val fileName = "TVBox_${variant.buildType.name}-$flavorName.apk"
...
dependencies {
    ...
    add("pythonImplementation", project(":pyramid"))
    ...
    implementation("com.squareup.okio:okio:3.3.0")
    implementation("com.github.CymChad:BaseRecyclerViewAdapterHelper:2.9.49-androidx")
    implementation("com.github.KingJA:LoadSir:1.3.8")
    implementation("com.google.code.gson:gson:2.10.1")
    implementation("com.github.bumptech.glide:glide:4.16.0")
    kapt("com.github.bumptech.glide:compiler:4.16.0")
    ...
    val media3 = "androidx.media3:media3"
    implementation("$media3-exoplayer:1.3.1")
    implementation("$media3-ui:1.3.1")
    implementation("$media3-exoplayer-dash:1.3.1")
    implementation("$media3-exoplayer-hls:1.3.1")
    implementation("$media3-exoplayer-rtsp:1.3.1")
    implementation("$media3-datasource-rtmp:1.3.1")
    implementation("$media3-common:1.3.1")
    implementation("com.github.anilbeesetti.nextlib:nextlib-media3ext:0.7.1")
    ...
    implementation("xyz.doikki.android.dkplayer:dkplayer-ui:3.3.7")
    implementation("xyz.doikki.android.dkplayer:videocache:3.3.7")
    implementation("com.github.jeasonlzy:okhttp-OkGo:v3.0.4")
    implementation("com.owen:tv-recyclerview:3.0.0")
    implementation("com.blankj:utilcodex:1.31.0")
    implementation("com.github.getActivity:XXPermissions:18.5")
    implementation("org.jsoup:jsoup:1.16.1")
